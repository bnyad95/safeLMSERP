...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('universities', function (Blueprint $table) {
            $table->boolean('prefinal_marks_open')->default(false);
            $table->foreignId('prefinal_marks_opened_by')->nullable()->constrained('users')->nullOnDelete();
            $table->timestamp('prefinal_marks_opened_at')->nullable();
        });
