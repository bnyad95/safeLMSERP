<x-app-layout>
    ...
    <div class="py-10"><div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm"><h3 class="font-semibold text-gray-900">Contact and organization</h3><dl class="mt-5 grid gap-5 sm:grid-cols-2"><div><dt class="text-xs text-gray-500">Email</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->email }}</dd></div><div><dt class="text-xs text-gray-500">Phone</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->phone ?: 'Not recorded' }}</dd></div><div><dt class="text-xs text-gray-500">National ID / Passport</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->national_id ?: 'Not recorded' }}</dd></div><div><dt class="text-xs text-gray-500">College</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->department->college->name ?? 'Not assigned' }}</dd></div><div><dt class="text-xs text-gray-500">Department</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->department->name ?? 'Not assigned' }}</dd></div><div class="sm:col-span-2"><dt class="text-xs text-gray-500">Address</dt><dd class="mt-1 text-sm font-medium text-gray-900">{{ $student->address ?: 'Not recorded' }}</dd></div></dl></section>
