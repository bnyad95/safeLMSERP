<x-modal name="print-ledger" max-width="4xl">
    <div class="flex h-[85vh] flex-col p-6">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Student Ledger') }}</h2>
        ...
        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Matches the ledger filters currently applied on this page.') }}</p>
