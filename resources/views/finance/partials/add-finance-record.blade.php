            ...
            <form method="POST" action="{{ route('finance.transactions.store') }}" class="mt-5 grid grid-cols-1 gap-4">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div class="min-w-0">
                        ...
                        <input type="number" step="0.01" min="0.01" name="amount" x-model="amount" value="{{ old('amount') }}" class="mt-1 block w-full min-w-0 rounded-md border-gray-300 bg-white text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100" required>
                    </div>

                    <div class="min-w-0">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Currency</label>
                        <select name="currency" class="mt-1 block w-full min-w-0 rounded-md border-gray-300 bg-white text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100" required>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div x-show="recordType !== 'invoice'" class="min-w-0">
                        ...
                        <input type="text" name="receipt_number" value="{{ old('receipt_number') }}" placeholder="Auto for payments/credits" class="mt-1 block w-full min-w-0 rounded-md border-gray-300 bg-white text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100">
                    </div>
                </div>
                ...
                <div x-show="['payment', 'discount', 'scholarship'].includes(recordType)" class="min-w-0">
                    ...
                    <select name="invoice_transaction_id" class="mt-1 block w-full min-w-0 truncate rounded-md border-gray-300 bg-white text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Used for payments, discounts, and scholarships. Currency and student must match the invoice.</p>
                </div>
