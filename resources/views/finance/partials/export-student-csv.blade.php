<x-modal name="export-student-csv" max-width="sm">
    <div class="p-6">
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Export Student CSV</h2>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Download this student's finance transactions as a CSV file.</p>
