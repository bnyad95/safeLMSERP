        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                @foreach($stats as $stat)
                    <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                        ...
                        <div class="mt-2 flex items-end justify-between">
                            ...
                            <span class="text-sm font-medium text-emerald-600">{{ $stat['change'] ?? __('Live') }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
            ...
            <div class="mt-8 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <span class="rounded-full bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700">{{ __('Live ERP view') }}</span>
                </div>
