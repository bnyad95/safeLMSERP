        ...
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <section class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="flex items-center justify-between gap-3 border-b border-gray-200 px-5 py-4">
                    ...
                    @if($filters['section_id'])
                        <a href="{{ route('course-sections.report', $filters['section_id']) }}" target="_blank" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-semibold text-gray-700 hover:bg-gray-50">Print Class Report</a>
                    @endif
                </div>
