    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600">Define and manage colleges for Bologna structure.</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($colleges as $college)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $college->code ?? 'N/A' }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $college->university->name ?? 'N/A' }}</td>
                                @if($canManageColleges)
