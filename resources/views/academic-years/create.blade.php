    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Open a new year by creating its semesters while reusing existing universities, colleges, departments, and Course Catalog records.</p>
            </div>
        ...
        <div class="mx-auto max-w-4xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <section class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This creates only semester periods. The existing catalog and structure remain available for the new year.</p>
                </div>
                <form method="POST" action="{{ route('academic-years.store') }}" class="space-y-5 p-5">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label for="first_semester_start_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">First Semester Start Date</label>
                            <input
                    ...
                    <div>
                        <label for="semester_length_months" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Semester Length In Months</label>
                        <input
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100"
                        >
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Leave the start date empty if dates are not ready yet.</p>
                    </div>

                    <div>
                        <label for="semester_names" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Semester Names</label>
                        <textarea
                            id="semester_names"
                            name="semester_names"
                            rows="4"
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Add one semester per line, or separate names with commas.</p>
                    </div>
